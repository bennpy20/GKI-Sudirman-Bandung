...
@section('page_title', 'Data Renungan Harian')
...
<div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-2 font-sans flex items-center gap-2">
            <i class="fas fa-book-reader text-church-gold"></i> Kelola artikel sapaan rohani dan renungan bagi jemaat.
        </p>
    </div>
    ...
    <div class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
        ...
        <a href="#" class="w-full sm:w-auto justify-center bg-gradient-to-r from-church-gold to-yellow-600 hover:from-yellow-500 hover:to-yellow-700 text-church-dark px-5 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5 whitespace-nowrap">
            <i class="fas fa-plus"></i> Buat Renungan
        </a>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-5 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
        <h3 class="font-bold text-church-dark text-lg">Daftar Renungan</h3>
    </div>
        ...
        <table class="w-full text-left border-collapse whitespace-nowrap">
            <thead>
                <tr class="bg-white text-gray-500 text-xs uppercase tracking-wider border-b border-gray-100">
                    ...
                    <th class="px-6 py-4 font-semibold">Ayat Bacaan</th>
            ...
            <tbody class="divide-y divide-gray-50 text-sm">
                ...
                <tr class="hover:bg-church-warm/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <div class="h-10 w-10 rounded-xl bg-orange-50 text-orange-600 flex items-center justify-center font-bold text-sm shadow-sm border border-orange-100">
                                <i class="fas fa-sun"></i>
                            </div>
                            <div>
                                <div class="font-bold text-church-dark text-base hover:text-church-gold cursor-pointer transition-colors">Tuhan Penolong yang Setia</div>
                                <div class="text-xs text-gray-500 mt-0.5">Dibuat 20 Mar 2026</div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <span class="font-medium text-gray-700">Mazmur 121:1-8</span>
                    </td>
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-bold bg-gray-100 text-gray-700 border border-gray-200">
                            Umum
                        </span>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2 text-gray-600">
                            <i class="fas fa-pen-nib text-church-gold/70"></i> Pdt. Yohanes
                        </div>
                    </td>
                    <td class="px-6 py-4">
                ...
                <tr class="hover:bg-church-warm/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <div class="h-10 w-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center font-bold text-sm shadow-sm border border-blue-100">
                                <i class="fas fa-child"></i>
                            </div>
                            <div>
                                <div class="font-bold text-church-dark text-base hover:text-church-gold cursor-pointer transition-colors">Menjadi Sahabat Yesus</div>
                                <div class="text-xs text-gray-500 mt-0.5">Dibuat 19 Mar 2026</div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <span class="font-medium text-gray-700">Yohanes 15:14-15</span>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2 text-gray-600">
                            <i class="fas fa-pen-nib text-church-gold/70"></i> Kak Maria (Guru SM)
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex justify-center space-x-2 transition-opacity">
    ...
    <div class="px-6 py-4 border-t border-gray-50 bg-gray-50/30 flex flex-col md:flex-row justify-between items-center gap-4">
        <span class="text-xs text-gray-500 font-medium text-center md:text-left">Menampilkan 1 hingga 2 dari 5 renungan</span>
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            ...
            text: "Artikel rohani ini akan dihapus secara permanen!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: 'Dihapus!',
                    text: 'Renungan telah sukses dihapus.',
                    icon: 'success',
