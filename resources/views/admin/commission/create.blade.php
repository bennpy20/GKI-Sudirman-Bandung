...
@section('page_title', 'Tambah Komisi')
...
<div class="mb-8">
    ...
    <h2 class="text-3xl font-serif font-bold text-church-dark mt-1">Buat Komisi Baru</h2>
    <p class="text-sm text-gray-500 font-sans mt-2 flex items-center gap-2">
        <i class="fas fa-users-cog text-church-gold"></i> Tambahkan entitas komisi kategorial baru ke dalam sistem gereja.
    </p>
</div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8 space-y-6">
                <div>
                    ...
                    <input type="text" name="name" required placeholder="Contoh: Komisi Pemuda" class="w-full px-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium">
                </div>
            </div>
        </div>
    </div>
