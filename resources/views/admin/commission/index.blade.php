...
@section('page_title', 'Manajemen Komisi')

@section('content')
<!-- Page Header -->
<div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
    <div>
        <h2 class="text-3xl font-serif font-bold text-church-dark">Master Komisi</h2>
        <p class="text-sm text-gray-500 mt-2 font-sans flex items-center gap-2">
            <i class="fas fa-info-circle text-church-gold"></i> Kelola data komisi kategorial yang ada di gereja.
        </p>
    </div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-5 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
        <h3 class="font-bold text-church-dark text-lg">Daftar Komisi Gereja</h3>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse whitespace-nowrap">
            <thead>
                <tr class="bg-white text-gray-500 text-xs uppercase tracking-wider border-b border-gray-100">
                    <th class="px-6 py-4 font-semibold w-2/3">Nama Komisi Kategorial</th>
                ...
                <tr class="hover:bg-church-warm/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-bold text-church-dark text-base">Komisi Pemuda</div>
                                <div class="text-xs text-gray-500 mt-0.5">Komisi Kategorial</div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                ...
                <tr class="hover:bg-church-warm/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-bold text-church-dark text-base">Komisi Dewasa</div>
                                <div class="text-xs text-gray-500 mt-0.5">Komisi Kategorial</div>
                            </div>
                        </div>
                    </td>
    ...
    <div class="px-6 py-4 border-t border-gray-50 bg-gray-50/30 flex flex-col md:flex-row justify-between items-center gap-4">
        <span class="text-xs text-gray-500 font-medium text-center md:text-left">Menampilkan 1 hingga 2 dari 5 entri</span>
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            title: 'Hapus Komisi?',
            text: "Jemaat yang terdaftar pada komisi ini akan kehilangan relasinya!",
            icon: 'warning',
