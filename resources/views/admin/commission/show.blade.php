...
@section('page_title', 'Detail Komisi')
...
<div class="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
    <div>
        ...
        <h2 class="text-3xl font-serif font-bold text-church-dark mt-1">Profil Komisi</h2>
    </div>
    ...
    <div class="flex gap-3">
        <a href="#" class="px-5 py-2.5 bg-white border border-church-gold/30 rounded-xl text-church-dark font-bold hover:bg-church-gold/10 transition-colors shadow-sm flex items-center gap-2 text-sm">
            <i class="fas fa-edit text-church-gold"></i> Edit Komisi
        </a>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div class="md:col-span-1 space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden text-center">
            ...
            <div class="relative px-6 pb-6 -mt-10">
                ...
                <h3 class="text-2xl font-serif font-bold text-church-dark">Komisi Pemuda</h3>
                <p class="text-sm font-medium text-gray-400 mt-1 uppercase tracking-widest">Komisi Kategorial GKI</p>
                
                <div class="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    <div class="text-3xl font-bold text-church-dark mb-1">210</div>
                    <div class="text-xs font-semibold text-gray-500 uppercase tracking-widest">Anggota Komisi</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="md:col-span-2 space-y-6">
        <!-- Mock Data Table for Members belonging to this commission -->
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-50 bg-gray-50/50 flex justify-between items-center">
                <h3 class="text-base font-bold text-church-dark">Sampel Anggota Komisi</h3>
            ...
            <div class="p-4 space-y-3 relative">
                ...
                <div class="flex items-center gap-4 p-3 hover:bg-gray-50 rounded-xl transition-colors border border-transparent hover:border-gray-100">
                    <div class="h-10 w-10 rounded-full bg-blue-50 text-blue-700 flex items-center justify-center font-bold text-sm">ST</div>
                    <div class="flex-1">
                        <div class="font-bold text-church-dark text-sm">Stefanus Tan</div>
                        <div class="text-xs text-gray-500 mt-0.5">Baptis Anak</div>
                    </div>
                    <div>
                ...
                <!-- Data Row -->
                <div class="flex items-center gap-4 p-3 hover:bg-gray-50 rounded-xl transition-colors border border-transparent hover:border-gray-100">
                    <div class="h-10 w-10 rounded-full bg-rose-50 text-rose-700 flex items-center justify-center font-bold text-sm">CW</div>
                    <div class="flex-1">
                        <div class="font-bold text-church-dark text-sm">Catherine Wijaya</div>
