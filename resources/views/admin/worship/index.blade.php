...
@section('page_title', 'Manajemen Ibadah')

@section('content')
<!-- Page Header -->
<div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
    <div>
        <h2 class="text-3xl font-serif font-bold text-church-dark">Ibadah Minggu</h2>
        <p class="text-sm text-gray-500 mt-2 font-sans flex items-center gap-2">
            <i class="fas fa-info-circle text-church-gold"></i> Kelola jadwal ibadah minggu, penatalayan, dan topik khotbah.
        </p>
    </div>
    
    <div class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
        <div class="relative w-full sm:w-auto">
            <input type="text" placeholder="Cari ibadah..." class="w-full sm:w-64 pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all shadow-sm text-sm">
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <table class="w-full text-left border-collapse whitespace-nowrap">
            <thead>
                <tr class="bg-white text-gray-500 text-xs uppercase tracking-wider border-b border-gray-100">
                    <th class="px-6 py-4 font-semibold w-2/5">Informasi Ibadah</th>
                    <th class="px-6 py-4 font-semibold">Teks Alkitab</th>
                    <th class="px-6 py-4 font-semibold">Waktu & Sesi</th>
            ...
            <tbody class="divide-y divide-gray-50 text-sm">
                ...
                <tr class="hover:bg-church-warm/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-bold text-church-dark text-base border-b border-dotted border-gray-300 hover:border-church-gold hover:text-yellow-700 cursor-pointer inline-block transition-colors pb-0.5">Berjalan Bersama Tuhan di Tengah Badai</div>
                                <div class="text-xs text-gray-500 mt-1 flex items-center gap-2">
                                    <span class="inline-flex items-center gap-1 text-[10px] font-bold px-1.5 py-0.5 rounded-md bg-purple-50 text-purple-700 border border-purple-100"><span class="w-1.5 h-1.5 rounded-full bg-purple-500"></span> Prapaskah 1</span>
                                    <i class="fab fa-youtube text-red-500 ml-1"></i> Live terpasang
                                </div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-white border border-gray-200 text-gray-700 shadow-sm">
                            <i class="fas fa-book-open text-church-gold mr-1.5"></i> Mazmur 23:1-6
                        </span>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex flex-col gap-1">
                            <span class="text-gray-700 font-bold"><i class="far fa-calendar-alt text-gray-400 w-4"></i> 26 April 2026</span>
                            <span class="text-xs text-gray-500"><i class="far fa-clock text-church-gold w-4"></i> Kebaktian Umum 1 (07:00)</span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                ...
                <tr class="hover:bg-church-warm/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <div class="h-10 w-10 rounded-xl bg-gray-100 text-gray-500 flex items-center justify-center font-bold text-sm shadow-sm border border-gray-200">
                                <i class="fas fa-cross"></i>
                            </div>
                            <div>
                                <div class="font-bold text-gray-500 text-base">Iman yang Menyelamatkan</div>
                                <div class="text-xs text-gray-400 mt-1 flex items-center gap-2">
                                    <span class="inline-flex items-center gap-1 text-[10px] font-bold px-1.5 py-0.5 rounded-md bg-green-50 text-green-700 border border-green-100 opacity-60"><span class="w-1.5 h-1.5 rounded-full bg-green-500"></span> Minggu Biasa</span>
                                </div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-white border border-gray-200 text-gray-700 shadow-sm">
                            <i class="fas fa-book-open text-church-gold mr-1.5"></i> Roma 10:9-10
                        </span>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex flex-col gap-1">
                            <span class="text-gray-500 font-bold line-through decoration-1"><i class="far fa-calendar-alt w-4 text-gray-400"></i> 19 April 2026</span>
                            <span class="text-xs text-gray-400"><i class="far fa-clock w-4 border-gray-400 text-gray-400"></i> Kebaktian Umum 2 (09:30)</span>
                            <span class="text-[10px] text-green-600 font-bold uppercase mt-0.5">Selesai</span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex justify-center space-x-2 transition-opacity">
    ...
    <div class="px-6 py-4 border-t border-gray-50 bg-gray-50/30 flex flex-col md:flex-row justify-between items-center gap-4">
        <span class="text-xs text-gray-500 font-medium text-center md:text-left">Menampilkan 1 hingga 2 dari 10 entri</span>
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            ...
            text: "Data jadwal beserta penugasan penatalayan akan ikut terhapus!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: 'Dihapus!',
                    text: 'Jadwal ibadah telah dihapus.',
                    icon: 'success',
