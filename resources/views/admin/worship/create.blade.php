...
@section('page_title', 'Tambah Ibadah Minggu')
...
<div class="mb-8">
    ...
    <h2 class="text-3xl font-serif font-bold text-church-dark mt-1">Jadwalkan Ibadah Minggu</h2>
    <p class="text-sm text-gray-500 font-sans mt-2 flex items-center gap-2">
        <i class="fas fa-calendar-alt text-church-gold"></i> Tentukan jadwal ibadah beserta panitia penatalayan yang bertugas.
    </p>
</div>
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" required placeholder="Contoh: Berjalan Bersama Tuhan di Tengah Badai" class="w-full px-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium lg:text-lg">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="bible_verse" placeholder="Misal: Mazmur 23:1-6" required class="w-full pl-11 pr-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium lg:text-lg">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="session" required class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark appearance-none font-medium">
                            <option value="" disabled selected>-- Pilih Sesi Ibadah --</option>
                            <option value="Kebaktian Umum 1 (07:00)">Kebaktian Umum 1 (07:00)</option>
                    ...
                    <div>
                        ...
                        <input type="date" name="date" required class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark font-medium">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="video_url" placeholder="https://youtube.com/watch?v=..." class="w-full pl-11 pr-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium">
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="liturgy_id" required class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark appearance-none font-medium">
                                    <option value="" disabled selected>-- Pilih Pekan Liturgi --</option>
                                    <option value="1">Minggu Biasa</option>
                                    <option value="2">Minggu Advent 1</option>
                                    <option value="3">Minggu Prapaskah 1</option>
                            ...
                            <div>
                                ...
                                <select name="liturgy_color" required class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark appearance-none font-medium">
                                    ...
                                    <option value="Ungu">Ungu (Pertobatan / Persiapan)</option>
                ...
                <div class="p-6 bg-gray-50/30 flex-1 space-y-4">
                    ...
                    <div class="p-4 bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col sm:flex-row gap-4">
                        <div class="w-full sm:w-1/2">
                            ...
                            <input type="text" name="guest_name[]" placeholder="Contoh: Paduan Suara GKI Maulana" class="w-full px-3 py-2.5 bg-gray-50/50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-church-gold outline-none transition-all focus:bg-white text-church-dark text-sm font-medium">
                        </div>
                        <div class="w-full sm:w-1/2 flex gap-2">
                            <div class="flex-1">
                                ...
                                <input type="text" name="guest_role[]" placeholder="Persembahan Pujian" class="w-full px-3 py-2.5 bg-gray-50/50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-church-gold outline-none transition-all focus:bg-white text-church-dark text-sm font-medium">
                            </div>
                            <div class="pt-6">
                                <button type="button" class="w-10 h-10 flex items-center justify-center text-red-500 bg-red-50 hover:bg-red-100 rounded-lg border border-red-100 transition-colors">
                                    <i class="fas fa-trash-alt"></i>
