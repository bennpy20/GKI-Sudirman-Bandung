...
<div class="mb-8 relative z-10">
    ...
    <h2 class="text-3xl font-serif font-bold text-church-dark mt-1">Sunting Data Profil Gereja</h2>
</div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8 space-y-6 flex flex-col items-center">
                <div class="w-full">
                    ...
                    <input type="text" name="name" value="{{ old('name', $about->name) }}" required class="w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark font-medium placeholder-gray-400 text-center md:text-left">
                    @error('name')
                ...
                <div class="w-full">
                    ...
                    <textarea name="description" required rows="10" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark font-medium leading-relaxed resize-y">{{ old('description', $about->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
