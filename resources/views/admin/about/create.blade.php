        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8 space-y-6 flex flex-col items-center">
                ...
                <div class="w-full">
                    ...
                    <input type="text" name="name" required placeholder="Contoh: Tema Setahun (2026)" class="w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark font-medium placeholder-gray-400 text-center md:text-left text-lg">
                </div>
                ...
                <div class="w-full">
                    ...
                    <textarea name="description" required rows="10" placeholder="Tuliskan isi keterangan mengenai profil ini selengkapnya di sini..." class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark font-medium leading-relaxed resize-y"></textarea>
                </div>
