...
<div class="mb-8">
    ...
    <h2 class="text-3xl font-serif font-bold text-church-dark mt-1">Perbarui Data Jemaat</h2>
    <p class="text-sm text-gray-500 font-sans mt-2 flex items-center gap-2">
        <i class="fas fa-edit text-church-gold"></i> Ubah data informasi jemaat Budi Santoso di bawah ini.
    </p>
</div>
...
<form action="#" method="POST">
            ...
            <div class="p-6 md:p-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" value="Budi Santoso" required class="w-full px-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium">
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Tempat, Tanggal Lahir</label>
                        <div class="flex gap-2">
                            <input type="text" name="birth_place" value="Bandung" class="w-1/2 px-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium text-sm">
                            <input type="date" name="birth_date" value="1985-03-15" class="w-1/2 px-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium text-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3 h-[46px]">
                            <label class="flex items-center justify-center gap-2 px-4 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors has-[:checked]:bg-church-gold/10 has-[:checked]:border-church-gold has-[:checked]:text-yellow-800 font-medium">
                                <input type="radio" name="gender" value="L" checked class="text-church-gold focus:ring-church-gold"> Laki-laki
                            </label>
                            <label class="flex items-center justify-center gap-2 px-4 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors has-[:checked]:bg-church-gold/10 has-[:checked]:border-church-gold has-[:checked]:text-yellow-800 font-medium">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="phone_number" value="081234567890" class="w-full pl-11 pr-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="budi.santoso@email.com" class="w-full pl-11 pr-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark font-medium">
                        </div>
                    </div>

                    <div class="md:col-span-2">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Alamat Lengkap</label>
                        <textarea name="address" rows="3" class="w-full px-5 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all focus:bg-white text-church-dark resize-none font-medium">Jl. Sudirman No. 123, RT 01/RW 02, Kel. Garuda, Kec. Andir, Kota Bandung</textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <select name="is_active" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark appearance-none font-medium">
                            <option value="1" selected>Aktif Melayani / Beribadah</option>
                    ...
                    <div>
                        ...
                        <select name="status" required class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark appearance-none font-medium">
                            ...
                            <option value="3" selected>Penatua</option>
                    ...
                    <div>
                        ...
                        <select name="membership" required class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark appearance-none font-medium">
                            ...
                            <option value="2" selected>Sidi</option>
                    ...
                    <div>
                        ...
                        <input type="date" name="join_date" value="2010-01-10" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark font-medium text-sm">
                    </div>
                </div>
            </div>
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <select name="regions_id" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-church-gold focus:border-church-gold outline-none transition-all text-church-dark appearance-none font-medium">
                            ...
                            <option value="1" selected>Galilea</option>
                    ...
                    <label class="flex items-center gap-3 p-4 bg-yellow-50/50 border border-yellow-100 rounded-xl cursor-pointer hover:bg-yellow-50 transition-colors group mt-[18px]">
                        <div class="relative flex items-center">
                            <input type="checkbox" name="is_region_leader" value="1" checked class="w-5 h-5 text-church-gold rounded border-gray-300 focus:ring-church-gold">
                        </div>
    ...
    <div class="fixed bottom-0 left-0 md:left-64 right-0 p-4 lg:p-6 bg-white/90 backdrop-blur-md border-t border-gray-200/60 z-30 flex justify-end gap-3 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] transition-all">
        ...
        <button type="submit" class="px-6 lg:px-8 py-2.5 lg:py-3 bg-gradient-to-r from-church-gold to-yellow-600 rounded-xl text-church-dark font-bold hover:from-yellow-500 hover:to-yellow-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-sm lg:text-base flex items-center gap-2">
            <i class="fas fa-save"></i> Perbarui Data Jemaat
        </button>
    </div>
</form>
