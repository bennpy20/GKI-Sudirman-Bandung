...
@section('page_title', 'Manajemen Wilayah')

@section('content')
<!-- Page Header -->
<div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
    <div>
        <h2 class="text-3xl font-serif font-bold text-church-dark">Wilayah & Rayon</h2>
        <p class="text-sm text-gray-500 mt-2 font-sans flex items-center gap-2">
            <i class="fas fa-info-circle text-church-gold"></i> Kelola data pembagian wilayah jemaat gereja di sini.
        </p>
    </div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-5 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
        <h3 class="font-bold text-church-dark text-lg">Daftar Wilayah</h3>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse whitespace-nowrap">
            <thead>
                <tr class="bg-white text-gray-500 text-xs uppercase tracking-wider border-b border-gray-100">
                    <th class="px-6 py-4 font-semibold w-1/4">Nama Wilayah</th>
                ...
                <tr class="hover:bg-church-warm/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-bold text-church-dark text-base">Rayon Galilea</div>
                                <div class="text-xs text-gray-500 mt-0.5">Kode: R-GAL</div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-normal">
                        <p class="text-sm text-gray-600 line-clamp-2">Mencakup jemaat yang berdomisili di area Bandung Barat, termasuk daerah Andir, Garuda, Rajawali, dan sekitarnya. Merupakan rayon dengan populasi terbanyak.</p>
                    </td>
                    <td class="px-6 py-4">
                ...
                <tr class="hover:bg-church-warm/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-bold text-church-dark text-base">Rayon Yerusalem</div>
                                <div class="text-xs text-gray-500 mt-0.5">Kode: R-YER</div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-normal">
                        <p class="text-sm text-gray-600 line-clamp-2">Wilayah Bandung Tengah, dipusatkan di sekitar Jalan Sudirman, Asia Afrika, dan Cibadak. Sangat dekat dengan lokasi kompleks gereja.</p>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex justify-center space-x-2 transition-opacity">
                            <button title="Detail" class="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 p-2 rounded-lg transition-colors border border-blue-100">
