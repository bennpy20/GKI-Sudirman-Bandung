...
@section('title')
    Visi & Misi - GKI Sudirman
@endsection

@section('content')
<div class="mb-10">
    <h2 class="text-3xl font-bold mb-2">Visi dan Misi</h2>
    ...
    @foreach($abouts as $about)
        @if($about->name === 'Visi')
            <div class="bg-white rounded-2xl border border-black/5 overflow-hidden card-shadow"
                ...
                <div x-show="open" class="p-5 text-church-dark/70 leading-relaxed border-t border-black/5 mt-2">
